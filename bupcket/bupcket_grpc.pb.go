...
type UploadClient interface {
	// Sends a greeting
	Send(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadReply, error)
}
...
func (c *uploadClient) Send(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadReply, error) {
	out := new(UploadReply)
	err := c.cc.Invoke(ctx, "/bupcket.Upload/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UploadServer interface {
	// Sends a greeting
	Send(context.Context, *UploadRequest) (*UploadReply, error)
...
func (UnimplementedUploadServer) Send(context.Context, *UploadRequest) (*UploadReply, error) {
...
func _Upload_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bupcket.Upload/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServer).Send(ctx, req.(*UploadRequest))
	}
...
var Upload_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "bupcket/bupcket.proto",
}
